function dxdt = QZSVItayhigher(t, x) % Quasi-Zero Stiffness Vibration Isolator with higher order taylor expansion = QZSVItayhigher
    ...
    wn = sqrt(wv^2 + 2*wk^2*(1-(8*l^3*L)/(8*l^4 + 4*l^2*x(1)^2 - x(1)^4 ))) ; 
